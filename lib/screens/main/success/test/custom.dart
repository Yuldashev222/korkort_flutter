...
class GifViewCustom extends StatefulWidget {
  ...
  @override
  GifViewCustomState createState() => GifViewCustomState();
}

class GifViewCustomState extends State<GifViewCustom> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GifViewCustom oldWidget) {
    super.didUpdateWidget(oldWidget);

    if (widget.isNext??false) {
      loadImage(updateFrames: true);
    }
  }
  ...
  FutureOr loadImage({bool updateFrames = false}) async {
